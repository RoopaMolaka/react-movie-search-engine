...
function App() {
  ...
  return (
   ...
   <div id='innerdiv'> <input value={movieName}    placeholder='search movie name'id='input1'
   onChange={(e)=>{setMovieName(e.target.value)}}/>
   {/* <button id='btn1-styling'> Go to wishlist</button> */}
           </div>
</div>
<div className='div-wrapper'>
    { movieName === "" ? popularMovies.map((item,index)=>{
       return<MovieCard 
